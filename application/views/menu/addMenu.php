    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <form class="form-horizontal form-label-left" method="POST" action="<?php echo site_url('menu/actAdd') ?>">
              ...
              <div class="item form-group <?= form_error('url_menu') ? 'has-error' : '' ?>">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="url_menu">Url
                </label>
                <div class="col-md-3 col-sm-3 col-xs-12">
              ...
              <div class="item form-group <?= form_error('line_menu') ? 'has-error' : '' ?>">
                ...
                <div class="col-md-2 col-sm-2 col-xs-2">
                  <input type="number" class="form-control col-md-7 col-xs-12" id="line_menu" name="line_menu" value="<?= $lineno->no ?>">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="checkbox">
                    <label class="col-sm-3">
                      <input type="checkbox" id="ismenu" name="ismenu" checked> Active
                    </label>
                  </div>
                </div>
              </div>
